...
SELECT product_id,               -- Columna 'product_id'
    price_cleaned AS price,             -- Columna 'price'
    average_units_sold_cleaned AS average_units_sold -- Columna 'average_units_sold'
FROM
    median_and_cleaned_products
WHERE
    product_type_cleaned IN ('Meat', 'Dairy') -- Filtra por tipos limpios
    AND average_units_sold_cleaned > 10; 